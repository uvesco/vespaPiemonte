...
#| title: Numero di catture per mese
...
# creo un dataframe con presenza/assenza di catture per ogni taxon
catture <- controlliGeoTemp %>%
...
# controlli per taxon (si escludono i NA per ogni taxon)

# catture <- catture %>%
#   pivot_longer(
#     cols = -AnnoMeseMedioCattura,
#     names_to = "taxon",
#     values_to = "catture"
#   )
# 
...
# p <- plot_ly(catture, x = ~AnnoMeseMedioCattura, y = ~taxa$colonne[1], type = 'bar', name = taxa$colonne[1])

# # Add a drop-down menu to switch between different 'y' variables
# p <- p %>%
#   layout(
#     updatemenus = list(
#       list(
...
#           list(
#             method = 'restyle',
#             args = list('y', list(df$y1)),
#             label = 'y1'
#           ),
#           list(
#             method = 'restyle',
#             args = list('y', list(df$y2)),
#             label = 'y2'
#           )
#         )
#       )
