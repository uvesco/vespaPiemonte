...
<!-- #| fig.height: 6 -->
<!-- #| fig.align: center -->
<!-- #| fig.cap: Numero totale di catture per mese -->
<!-- #| fig.link_text: Visualizza il grafico a tutto schermo -->
<!-- #| fig.link_url: https://plotly.com/~giorgio.guarnera/1/ -->
<!-- #| fig.show_link: true -->
<!-- #| fig.save: true -->
<!-- #| fig.filename: cattureMeseTot -->
<!-- #| fig.ext: html -->
<!-- #| fig.keep_md: false -->
<!-- #| fig.keep_html: false -->
<!-- #| fig.keep_pdf: false -->
...
<!-- p <- plot_ly(data = cattureTot, labels = taxa$etichette, values = cattureTot[[mesi[1]]], type = "pie", sort = FALSE) -->
