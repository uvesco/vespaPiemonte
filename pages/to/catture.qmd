...
datatable(cattureVespa, rownames = FALSE, colnames = c("Data controllo", "Data carica", "Trappola","Vespa velutina (individui)", "Distanza dal nido più vicino"), options = list(pageLength = 10, lengthMenu = c(5, 10, 15, 20), searching = TRUE, order = list(1, "desc")))
