...
# q: how to add a switcher for base maps in leaflet?
# a: use addProviderTiles() multiple times
# q: ok, but i need a switcher for the user to choose the base map
# a: use addLayersControl() with the overlayGroups argument
# 
...
leaflet(options = leafletOptions(zoomControl = TRUE,
  ...
  addCircleMarkers(data = cattureVespa, radius = 4, color = "white", weight = 1, fillOpacity = 1, fillColor = "magenta", 
    ...
    # addAwesomeMarkers(data = nidi,
    #                 icon = awesomeSquareIcon#,
    #                 #popup = ~paste("Mean Value:", mean_values)
    #                 ) %>%  
...
# addLegend("bottomright", colors = c("green", "orange", "red", "white"), labels = c("meno di 14 giorni", "tra 14 e 21 giorni", "più di 21 giorni", "rimosse"), title = "Ultimo controllo") %>%
  addLayersControl(
    baseGroups = c("Esri WorldTopoMap", "Opentopomap", "Stadia Alida Smooth", "OSM", "StamenTonerLite"),
